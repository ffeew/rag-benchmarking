...
def test_patch_dataset_writes_only_supplied_fields(client: TestClient, seed_dataset: models.Dataset) -> None:
...
def test_patch_dataset_can_clear_override_with_explicit_null(client: TestClient, seed_dataset: models.Dataset) -> None:
...
def test_patch_dataset_rejects_name_collision(client: TestClient, seed_dataset: models.Dataset) -> None:
...
def test_patch_dataset_forbids_unknown_field(client: TestClient, seed_dataset: models.Dataset) -> None:
